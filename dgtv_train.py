...
if __name__ == "__main__":
    ...
    parser.add_argument("--admm_iter", default=4)
    parser.add_argument("--epoch", default=200, type=int)
    parser.add_argument("--umax", default=65, type=float)
    parser.add_argument("--umin", default=50, type=float)
    ...
    logging.basicConfig(
        filename="log/dgtv_train_{0}.log".format(time.strftime("%Y-%m-%d-%H%M")),
        filemode="a",

...
def main(seed, model_name, cont=None, optim_name=None, subset=None, epoch=100):
    ...
    for epoch in range(total_epoch):  # loop over the dataset multiple times
        ...
        for i, data in enumerate(dataloader, 0):  # start index at 0
            ...
            torch.nn.utils.clip_grad_norm_(cnnu_params, 5)
...
opt = OPT(batch_size = 50, admm_iter=4, prox_iter=3, delta=.9, channels=3, eta=.3, u=25, lr=8e-6, momentum=0.9, u_max=1e2, u_min=1e-2)

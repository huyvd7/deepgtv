...
def main(seed, model_name, cont=None, optim_name=None, subset=None, epoch=100):
    ...
    optimizer = optim.SGD([
                {'params': cnny_params, 'lr':opt.lr*2},
                 {'params': cnnf_params , 'lr': opt.lr*50},
                 {'params': cnnu_params , 'lr': opt.lr*3.5}
...
opt = OPT(batch_size = 50, admm_iter=4, prox_iter=3, delta=.1, channels=3, eta=.3, u=25, lr=8e-6, momentum=0.9, u_max=1e2, u_min=1e-2)
